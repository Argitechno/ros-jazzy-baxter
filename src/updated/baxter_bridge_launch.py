...
def generate_launch_description():
    ...
    bridge_params = [{
        'robot_ip': '169.254.7.105',
        'robot_hostname': '011608P0034.local',
        'ros_hostname': '011608P0034.local',
        'ros_master_uri': 'http://011608P0034.local:11311',
        'use_baxter_description': True
    }]

    baxter_embedded = Node(
